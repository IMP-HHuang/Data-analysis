...
void gui::ControlPanel(TGCompositeFrame *TabPanel)
{
	...
	TGHorizontalFrame *ParFrame = new TGHorizontalFrame(MainFrame, 900, 40);
	...
	TGHSplitter *hsplitter = new TGHSplitter(MainFrame, 900,2);
	...
	MainFrame->AddFrame(DrawFrame, new TGLayoutHints(kLHintsTop | kLHintsLeft, 0, 0, 0, 0));
